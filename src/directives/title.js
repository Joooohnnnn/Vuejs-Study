...
function showTitle(el, title) {
    ...
    if (title === undefined) {
        ...
        const reghtOffset = parseInt(elComputedStyle.getPropertyValue('padding-right')) || 0
        ...
        popoverStyle.left = elRect.left - popover.offsetWidth / 2 + (el.offsetWidth - reghtOffset) / 2 + 'px'
